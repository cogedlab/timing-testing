/**
 * jspsych-survey-text-table-feedback
 * a jspsych plugin for feedback of free response survey questions in table format
 *
 * Spencer Chu
 * 
...
(function($) {
    jsPsych['survey-text-table-feedback'] = (function() {
        ...
        plugin.trial = function(display_element, trial) {
            ...
            for (var i = 0; i < trial.questions.length; i++) {
                ...
                $("#jspsych-survey-text-table-" + i).append('<table><tr><td width=600>' + trial.questions[i] + '</td></tr>');
            ...
            $("#jspsych-survey-text-table-next").html('Continue');
